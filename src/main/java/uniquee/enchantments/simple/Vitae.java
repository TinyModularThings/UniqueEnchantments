...
public class Vitae extends UniqueEnchantment
{
	...
	public static final DoubleStat BASE_BOOST = new DoubleStat(29.4826318204D, "base_boost");
	public static final DoubleStat SCALE_BOOST = new DoubleStat(1D, "scale_boost");
	public static final BooleanStat ALT_FORMULA = new BooleanStat(false, "alt_formula");
	...
	public Vitae()
	{
		...
		addStats(BASE_BOOST, SCALE_BOOST, ALT_FORMULA);
	}
