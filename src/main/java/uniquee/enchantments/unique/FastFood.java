...
public class FastFood extends UniqueEnchantment
{
	...
	public FastFood()
	{
		super(new DefaultData("fastfood", Rarity.RARE, 2, true, true, 14, 6, 10).setTrancendenceLevel(200), EnchantmentType.WEAPON, EquipmentSlotType.MAINHAND, EquipmentSlotType.OFFHAND);
