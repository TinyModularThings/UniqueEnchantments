...
public class EnchantmentDemetersSoul extends UniqueEnchantment
{
	...
	{
		super(new DefaultData("demeters_soul", Rarity.VERY_RARE, 3, true, 20, 10, 40), EnumEnchantmentType.BREAKABLE, new EntityEquipmentSlot[]{EntityEquipmentSlot.MAINHAND, EntityEquipmentSlot.OFFHAND});
		setCategory("utils");
	}
	...
	public void loadData(Configuration config)
	{
		...
		SCALING.handleConfig(config, getConfigName());
