...
public class MountingAegisEnchantment extends UniqueEnchantment
{
	...
	{
		super(new DefaultData("mounting_aegis", Rarity.RARE, 1, true, 24, 4, 20), EnchantmentType.ALL, new EquipmentSlotType[]{EquipmentSlotType.MAINHAND, EquipmentSlotType.OFFHAND});
	}
