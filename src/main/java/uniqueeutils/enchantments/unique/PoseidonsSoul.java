...
{
	public static final INamedTag<Block> POSEIDONS_SOUL = BlockTags.createOptional(new ResourceLocation("uniquee", "poseidons_soul"));
	public static final IntStat BASE_CONSUMTION = new IntStat(16, "base_consumtion");
	
	public PoseidonsSoul()
	{
		super(new DefaultData("poseidons_soul", Rarity.RARE, 3, true, false, 24, 4, 75).setHardCap(40), EnchantmentType.TRIDENT, EquipmentSlotType.MAINHAND, EquipmentSlotType.OFFHAND);
