...
public class AlchemistsBlessing extends UniqueEnchantment
{
	...
	{
		super(new DefaultData("alchemists_blessing", Rarity.VERY_RARE, 4, true, 26, 12, 10), EnchantmentType.DIGGER, EquipmentSlotType.MAINHAND, EquipmentSlotType.OFFHAND);
