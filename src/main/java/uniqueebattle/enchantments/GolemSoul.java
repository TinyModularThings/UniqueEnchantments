...
public class GolemSoul extends UniqueEnchantment
{
	...
	public static final DoubleStat SPEED = new DoubleStat(0.25D, "speed");
	
	public GolemSoul()
	{
		super(new DefaultData("golem_soul", Rarity.COMMON, 4, false, 16, 3, 50), EnumEnchantmentType.ARMOR_CHEST, EntityEquipmentSlot.CHEST);
		setCategory("battle");
